...
function promedioResultadosTest(resultadosTest) {
  ...
  // Tu código:
  return (resultadosTest.reduce(function(a, b){ return (a + b); }) / resultadosTest.length)
}
...
function mesesDelAño(array) {
  ...
  // Tu código:
  let meses = (array.filter(elemento => ((elemento ==="Enero") || (elemento === "Marzo") || (elemento === "Noviembre"))))
